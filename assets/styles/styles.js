...
//BORDER RADIUS
export const rounded_sm = 5;
export const rounded_md = 10;
export const rounded_lg = 20;
export const rounded_full = 50;

//Border sizes
export const border_sm = 0.5;
export const border_md = 1.5;
export const border_lg = 3;
export const border_xl = 4;
